...
<html lang="en">
  ...
  <head>
    ...
    <title>Refund Policy | Diagnomitra</title>
    <meta name="description" content="Learn about our terms for refunds, eligibility criteria, and the process for requesting a refund for our services." />
    <link rel="canonical" href="https://www.diagnomitra.com/refund-policy" />
...
<script>
  ...
  gtag('config', 'G-M7L29W0RRD');
    ...
    <meta name="keywords" content="Blood test at home, Blood test package, Blood test package near me, Blood test home service, Blood test home collection near me, Blood test discount, Blood test package price
">
  ...
  @include('header')
        ...
        <section id="system-policies_1" class="privacy_policy see-section see-light-color">
          <div class="see-full jw-full">
            <div class="see-width jw-width container background">
              <div class="privacy-wrapper see-full jw-full">
                <div class="heading see_title em_system-policies_1_title">
                  Refund Policy
                </div>
                  ...
                  <div class="desp para">
                    <ol>
                      <li>
                        ...
                        <ol>
                          <li>
                            Customers can cancel their booking any time before the sample collection is done. No or minimum cancellation charges will be applied.
                          </li>
                          <li>
                        ...
                        <ol>
                          <li>
                            If cancellation has been initiated by customers who have done the booking using online payment method, they can make the request for the refund to be credited either in their payment platform selected at the time of booking.
                          </li>
                          <li>
                            Customer will be eligible for a full and/or partial refund in case the respective testing Lab is unable to provide the report within the Turnaround Time (TAT) mentioned at the time of booking.
                          </li>
                          <li>
                            Customers need to raise their refund request either by calling 7532075184 or writing an email to help@diagnomitra.com.
                          </li>
                          <li>
                            Refunds might take 5-7 business days to get credited in the customer&rsquo;s account.
                          </li>
                          <li>
                            Refund for any cash transaction will be credited in Customer&rsquo;s Wallet only when applicable with mobile platform.
                          </li>
                          <li>
                            No refund request will be entertained once the Lab has generated the test report within TAT.
                          </li>
                          <li>
                            No refund request will be entertained 15 days after a sample collection has been done.
                          </li>
                        </ol>
                      </li>
                    </ol>
    ...
    text-align: center;
      ...
      <footer class="footer background5" id="footer_2" style="width: 100%">
          ...
          <div class="row d-flex justify-content-between py-5 gap-4">
            <div class="col-lg-4 col-md-6 col-sm-12">
              <div class="footer_style">
                <a href="javascript:void(0);" class="footer_logo media-fit"
                  ><img
                    src="static.joonsite.com/storage/21443/media/2404241259411841.png"
                    alt=""
                /></a>
                <div class="fontStyle7 mt-3 theme-subtitle">
                  Your Trusted Healthcare Partner. Streamlining healthcare
                  access with accurate diagnostics, advanced technologies, and
                  expert care. Experience convenience, reliability, and
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
              <div class="footer_style footer_new">
                ...
                <ul>
                  <li>
                    <a href="index.html" class="fontStyle7"
                      ><i class="fa-solid fa-caret-right"></i>Home</a
                    >
                  </li>
                  <li>
                    <a href="about-us.html" class="fontStyle7"
                      ><i class="fa-solid fa-caret-right"></i>About Us</a
                    >
                  </li>
                  <li>
                    <a href="partner.html" class="fontStyle7"
                      ><i class="fa-solid fa-caret-right"></i>Partner</a
                    >
                  </li>
                  <li>
                    <a href="blog.html" class="fontStyle7"
                      ><i class="fa-solid fa-caret-right"></i>Blog</a
                    >
                  </li>
                  <li>
                    <a href="contact-us.html" class="fontStyle7"
                      ><i class="fa-solid fa-caret-right"></i>Contact Us</a
                    >
                  </li>
                  <li>
                    <a href="javascript:void(0);" class="fontStyle7"
                      ><i class="fa-solid fa-caret-right"></i>Policy</a
                    >
                  </li>
                </ul>
              </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
              ...
              <div class="footer_style">
                <div
                  class="footer_icon pb-3 light-border fontStyle7 mb-3 d-flex"
                >
                  <i class="fa-solid fa-envelope"></i> help@diagnomitra.com
                </div>
                <div
                  class="footer_icon pb-3 light-border fontStyle7 mb-3 d-flex"
                >
                  <i class="fa-solid fa-envelope"></i> diagnomitralabs@gmail.com
                </div>
                <div class="footer_icon fontStyle7 mb-3 d-flex">
                  <i class="fa-solid fa-phone"></i> 9990473738
                </div>
              </div>
            </div>
          </div>
          <div
            class="footer_socel_icon d-flex gap-10 mb-5 justify-content-center"
          >
            <div class="fontStyle8 rounded-circle background1">
              <a href="https:// https://www.facebook.com/Diagnomitra"
                ><i class="fab fa-facebook-f"></i
              ></a>
            </div>
            <div class="fontStyle8 rounded-circle background1">
              <a href="https://www.instagram.com/diagnomitra/"
                ><i class="fab fa-instagram"></i
              ></a>
            </div>
            <div class="fontStyle8 rounded-circle background1">
              <a
                href="https://www.linkedin.com/company/diagnomitra-healthcare/mycompany/?viewAsMember=true"
        ...
        <div class="w-100 m-0 background1">
          <div class="container">
            <div
              class="footer_copy py-2 d-flex justify-content-center flex-wrap fontStyle7"
            >
              <div class="fontStyle8">
                Copyright © Diagnomitra healthcare solutions pvt ltd 2024. All rights reserved.
              </div>
            </div>
          </div>
        </div>
...
<script>
  console.log("JWBolt - Page loaded in 0.28131794929504 seconds");
</script>
