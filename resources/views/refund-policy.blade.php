...
<body>
@include('header')
 <section id="system-policies_1" class="privacy_policy see-section  see-light-color  "><div class="see-full jw-full"><div class="see-width jw-width"><div class="privacy-wrapper see-full jw-full"><div class="privacy-policy-heading ">Refund Policy</div><div class="content-div"><div class="desp para "><ol><li><p><strong>Cancellation</strong></p><ol><li>Customers can cancel their booking any time before the sample collection is done. No or minimum cancellation charges will be applied.</li><li>No cancellation will be allowed post sample collection.</li></ol><p><strong>Refund</strong></p><ol><li>If cancellation has been initiated by customers who have done the booking using online payment method, they can make the request for the refund to be credited either in their payment platform selected at the time of booking.</li><li>Customer will be eligible for a full and/or partial refund in case the respective testing Lab is unable to provide the report within the Turnaround Time (TAT) mentioned at the time of booking.</li><li>Customers need to raise their refund request either by calling 7532075184 or writing an email to help@diagnomitra.com.</li><li>Refunds might take 5-7 business days to get credited in the customer&rsquo;s account.</li><li>Refund for any cash transaction will be credited in Customer&rsquo;s Wallet only when applicable with mobile platform.</li><li>No refund request will be entertained once the Lab has generated the test report within TAT.</li><li>No refund request will be entertained 15 days after a sample collection has been done.</li></ol></li></ol></div></div></div></div></div></section>
 @include('footer')
...
</html><script>console.log('JWBolt - Page loaded in 0.28131794929504 seconds')</script>