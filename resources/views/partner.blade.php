...
<html lang="en">
  ...
  <head>
    ...
    <title>Partner with Diagnomitra for Blood Test Full Body</title>
    <meta name="description" content="Partner with Diagnomitra to provide comprehensive blood test full body services, blood test sample collection at home services" />
    <link rel="canonical" href="https://www.diagnomitra.com/partnerl" />
...
<script>
  ...
  gtag('config', 'G-M7L29W0RRD');
    ...
    <meta name="keywords" content="Blood test at home, Blood test package, Blood test full body, Blood test to detect heart attack, Blood test before surgery, Blood test to detect pcod/pcos, Blood test to detect pregnancy, Blood test sample collection
    ">
  ...
  @include('header')
      <style>
        #breadcrumb_1 .theme-title .jwset {
          font-size: px;
          font-family: ;
          font-weight: ;
          line-height: ;
      ...
      ><style>
        ...
        .breadcrumb-content:nth-child(2):after {
          content: " ";
        }
      </style>
      <section
        class="breadcrumbs section-padding background6 align-items-center"
        style="
          background-image: url(https://diagnomitra.s3.amazonaws.com/partner/ourpart.jpg);
      ...
      >
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <div class="breadcrumbs_style text-start text-lg-center">
                <!-- <div class="headingfontss mb-2"> Partners</div> -->
                <!-- <div class="fontStyle8">
                  <span class="breadcrumb-content fontStyle8"
                    ><a href="index.html">Home</a></span
                  ><span class="breadcrumb-content fontStyle8"
                    ><a href="partner.html">Partner</a></span
                  >
                </div> -->
              </div>
            </div>
  ...
  font-family: "IBM Plex Sans", sans-serif;
      ...
      <section class="section-padding" id="content_2">
        <div class="container">
          <div class="px-3 content-padding text-start text-lg-start">
            <div class="fontStyle3 mg-1 theme-title">
              <span class="jwset"
                ><span style="color: var(--color1)">Our</span>
                <span style="color: var(--color3)">Partners :-</span></span
              >
            </div>
            <div class="content_data fontStyle7 mg-2">
              <h5>At Diagnomitra, we believe in building strong partnerships that contribute to the betterment of healthcare services. Our partners are at the heart of our mission to provide affordable, reliable, and comprehensive diagnostic solutions. Together, we ensure that every individual has access to top-quality healthcare services right at their doorstep.</h5>
                <h5 class="mt-3 mb-3">Why Partner with Diagnomitra? </h5>
               <h5><span style="color:#B1365B ;">Expand Your Reach:</span><p>
                Join our network and reach a wider audience. With our platform, you can connect with users across India who are looking for affordable home blood tests and the best health checkup packages</p></h5>
            <h5><span style="color:#B1365B ;">Boost Your Revenue:</span>
              <p>Our seamless online lab test booking system ensures a steady flow of bookings, helping you increase your revenue. Benefit from our discounted health checkup packages that attract more customers to your lab.</p></h5>

              <h5><span style="color:#B1365B ;">Enhance Service Quality:</span>
               <p> Partnering with Diagnomitra means being part of a trusted network of NABL certified labs for blood tests. Our home sample collection services guarantee convenience for users, while ensuring accurate home blood test reports.</p></h5>
                <h5><span style="color:#B1365B ;">Streamlined Operations:</span>
                 <p> We manage all logistics from test booking to home sample collection, allowing you to focus on delivering reliable diagnostic tests near your location. Our end-to-end service enhances efficiency and reduces operational burdens.</p></h5>

                  <h5><span style="color:#B1365B ;">Promote Your Services:</span>
                   <p> Take advantage of our platform to run promotional offers and advertisements. Highlight your comprehensive health checkup for families and attract more clients with your specialized services.</p></h5>
         <h5> Our Commitment to Partners
            We are committed to supporting our partners by providing:</h5>
          <ul>
            <li>A robust platform for online lab test booking.
            </li>
            <li>Comprehensive marketing and promotional support.
            </li>
            <li>Efficient logistics management for home sample collection services.
            </li>
            <li>Opportunities to participate in discounted health checkup packages.
            </li>
            <li>Assurance of accurate and timely test reports to enhance customer satisfaction.
            </li>
          </ul>

          <h4 class="mt-2">Join Us
            Become a part of the Diagnomitra family and contribute to a healthier India. By partnering with us, you are joining a mission to make healthcare accessible, affordable, and reliable for everyone.</h4>
          
            <h4>Our Valued Partners
              We are proud to collaborate with some of the best NABL certified labs for blood tests across the country. Our partners share our vision of providing the highest quality diagnostic services and are integral to our success.</h4>
                 
              <h5>Join Diagnomitra today and be a part of a revolutionary approach to healthcare diagnostics.</h5>
  ...
  font-family: "IBM Plex Sans", sans-serif;
      ...
      <section
        class="padding-4 about-page about1 position-relative background4"
        id="about_3"
      >
        <div class="container">
            ...
            <div class="col-lg-3 col-md-4 col-sm-12">
              <figure class="media-fit">
                <a href="javascript:void(0);"
                  ><img
                    class=""
                    src="https://diagnomitra.s3.amazonaws.com/partner/logo123.webp"
                    alt=""
                /></a>
              </figure>
            </div>
            <div
              class="col-lg-9 col-md-8 col-sm-12 flex-grow-1 content-padding px-3"
            >
              <div class="text-start text-lg-start">
                ...
                <div class="para fontStyle7 content_data">
                  CNC Pathlab based in&nbsp;capital of India, the diagnostic
                  centre offers an impeccable patient care provided by
                  staff&nbsp;and also the&nbsp;ambient environmental facilities.
                  These benchmarks mark them&nbsp;joined&nbsp;of&nbsp;the
                  foremost&nbsp;reputed diagnostic centres&nbsp;within
      ...
      <section
        class="padding-4 about-page about1 position-relative"
        id="about_4"
      >
        <div class="container">
          <div
            class="about-row d-flex flex-wrap flex-row-reverse align-items-center"
          >
            <div class="col-lg-3 col-md-4 col-sm-12">
              <figure class="media-fit">
                <a href="javascript:void(0);"
                  ><img
                    class=""
                    src="static.joonsite.com/storage/21443/media/2404301207029349.jpg"
                    alt=""
                /></a>
              </figure>
            </div>
            ...
            >
              <div class="text-start text-lg-start">
                ...
                <div class="para fontStyle7 content_data">
                  <h6>
                  MolQ diagnostic lab provides quality diagnostic services,
                  within a given particular time frame and that too, in a cost
                  effective manner. Equipped with highly skilled phlebotomists,
                  who take blood samples in a sanitary way, MolQ is worth opting
                  for.</h6>
                </div>
              </div>
            </div>
          ...
          <div class="about-row d-flex flex-wrap flex-row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-12">
              <figure class="media-fit">
                <a href="javascript:void(0);"
                  ><img
                    class=""
                    src="static.joonsite.com/storage/21443/media/2404241324284548.webp"
                    alt=""
                /></a>
              </figure>
            </div>
            ...
            >
              <div class="text-start text-lg-start">
                ...
                <div class="para fontStyle7 content_data">
                  Thyrocare Medical Test Labs, a beacon of innovation and
                  reliability in the realm of diagnostic healthcare, stands as a
                  testament to pioneering excellence in the field.
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div class="col-lg-3 col-md-4 col-sm-12">
              <figure class="media-fit">
                <a href="javascript:void(0);"
                  ><img
                    class=""
                    src="static.joonsite.com/storage/21443/media/2404241324277316.webp"
                    alt=""
                /></a>
              </figure>
            </div>
            ...
            >
              <div class="text-start text-lg-start">
                ...
                <div class="para fontStyle7 content_data">
                  Niramaya Healthcare is an elite Pathology and Wellness service
                  provider with presence in the National Capital Region of
                  Delhi. It was started by a group of professionals with the
                  motto of &quot;Affordable, Accurate and Accredited pathology
                  at your footstep&quot;.&nbsp;
                </div>
              </div>
            </div>
          ...
          <div class="about-row d-flex flex-wrap flex-row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-12">
              <figure class="media-fit">
                <a href="javascript:void(0);"
                  ><img
                    class=""
                    src="static.joonsite.com/storage/21443/media/2404241324247406.webp"
                    alt=""
                /></a>
              </figure>
            </div>
            ...
            >
              <div class="text-start text-lg-start">
                ...
                <div class="para fontStyle7 content_data">
                  Agilus Diagnostics has the largest network of NABL accredited
                  labs &nbsp;as of March 31, 2023 (Source: CRISIL Report). We
                  have an extensive diagnostics network in India spread across
                  25 states and five union territories covering over 1,000 towns
                  and cities and over 532 districts, as of March 31, 2023.
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div class="col-lg-3 col-md-4 col-sm-12">
              <figure class="media-fit">
                <a href="javascript:void(0);"
                  ><img
                    class=""
                    src="static.joonsite.com/storage/21443/media/2404301207221912.jpg"
                    alt=""
                /></a>
              </figure>
            </div>
            ...
            >
              <div class="text-start text-lg-start">
                ...
                <div class="para fontStyle7 content_data">
                  <p>
                    Our view on healthcare is that, like much else, it should
                    reach our homes &ndash; conveniently and affordably.We
                    believe being connected to&nbsp;your doctor&nbsp;matters. A
                    personal connect and context in healthcare cannot be
                    replaced.Effective medicine will be when online and offline
                    worlds combine.&nbsp;
                  </p>
                </div>
              </div>
          ...
          <div class="about-row d-flex flex-wrap flex-row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-12">
              <figure class="media-fit">
                <a href="javascript:void(0);"
                  ><img
                    class=""
                    src="static.joonsite.com/storage/21443/media/2404241324268978.webp"
                    alt=""
                /></a>
              </figure>
            </div>
            ...
            >
              <div class="text-start text-lg-start">
                ...
                <div class="para fontStyle7 content_data">
                  At Healthians, we are on a mission to redefine healthcare by
                  placing the power of comprehensive wellness firmly in your
                  hands. We understand that your health is not just a matter of
                  moments, but a lifelong journey deserving of attention, care,
                  and empowerment.
                </div>
              </div>
            </div>
      ...
      <div class="banner2-popup" id="popup_11" data-popup="248962">
...
<script>
  console.log("JWBolt - Page loaded in 0.63345408439636 seconds");
</script>
