                    ...
                    <div class="col-12 col-sm-12 col-md-6">
                        <div class="row welcome_form_row">
                            <div class="contactRight contactRight_1 py-3 px-4 background5">
                                ...
                                <form name="form_v_1" action="{{ route('booktest.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <li data-input="text" data-mode="system">
        <label>Full Name</label>
        <input type="text" name="full_name" placeholder="Enter Name" maxlength="100" required>
    </li>
    <li data-input="email" data-mode="system">
        <label>Email</label>
        <input type="email" name="email" placeholder="Enter Your Email" maxlength="100" required>
    </li>
    <li data-input="tel" data-mode="system">
        <label>Mobile Number</label>
        <input type="tel" name="mobile_number" placeholder="Enter Number" maxlength="15" required>
    </li>
    <li data-input="text" data-mode="system">
        <label>Your Location</label>
        <input type="text" name="location" placeholder="Enter Location" maxlength="100" required>
    </li>
    <li data-input="singlefile" data-mode="normal">
        <label>Upload Prescription</label>
        <input type="file" name="prescription" accept=".pdf,.doc,.docx,.txt,.xls,.ppt">
    </li>
...
@endif
            ...
            <div class="row">
                <div class="fade_22 p-0">
                    <div class="slide_img_2"><img
                            src="static.joonsite.com/storage/21443/media/2404261825420411d755.png?class=thumb" alt="">
                    </div>
                    <div class="slide_img_2"><img
                            src="static.joonsite.com/storage/21443/media/2404241345005619d755.png?class=thumb" alt="">
                    </div>
                    <div class="slide_img_2"><img
                            src="static.joonsite.com/storage/21443/media/2404261825451107d755.png?class=thumb" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="columns-content p-4 background4 border-radius-2">
                <div class="row gy-4">
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="column-item text-center text-lg-center">
                            <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                        src="static.joonsite.com/storage/21443/media/2405081513065263d755.png?class=thumb"
                                        alt=""></a></div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="column-item text-center text-lg-center">
                            <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                        src="static.joonsite.com/storage/21443/media/2405081513259803d755.png?class=thumb"
                                        alt=""></a></div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="column-item text-center text-lg-center">
                            <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                        src="static.joonsite.com/storage/21443/media/2405081534050600d755.png?class=thumb"
                                        alt=""></a></div>
                            <div class="comm-btn mt-4 fontStyle8"><a href="{{ URL::asset('contact-us')}}" target="_self"
                                    class="btn-1 btn-lg mx-1 background1
                                    ">Fill Form</a></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-center text-lg-center content-padding">
                <div class="fontStyle3 mg-1 theme-title"><span class="jwset">
                        <p>Why Choose <span style="color:var(--color1);">Diagno</span><span
                                style="color:var(--color3);">mitra</span><span style="color:var(--color3);"></span></p>
                    </span></div>
            </div>
                ...
                <div class="row gy-4">
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="column-item text-center text-lg-start">
                            <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                        src="static.joonsite.com/storage/21443/media/2404241336041112d755.png?class=thumb"
                                        alt=""></a></div>
                            <div class="fontStyle4 mg-0 theme-listTitle"><span class="jwset">
                                    <p><span style="color:var(--color6);"><strong>Transparent Pricing</strong></span>
                                    </p>
                                </span></div>
                            <div class="fontStyle7 mg-1 theme-listSubtitle">Experience honesty and transparency with our
                                straightforward pricing model, ensuring optimal value for your health.</div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="column-item text-center text-lg-start">
                            <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                        src="static.joonsite.com/storage/21443/media/2404241340543193d755.png?class=thumb"
                                        alt=""></a></div>
                            <div class="fontStyle4 mg-0 theme-listTitle"><span class="jwset">
                                    <p><span style="color:var(--color6);"><strong>NABL Certified Labs</strong></span>
                                    </p>
                                </span></div>
                            <div class="fontStyle7 mg-1 theme-listSubtitle">Trust in the accuracy and reliability of
                                your results with our commitment to partnering with certified and licensed labs.</div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="column-item text-center text-lg-start">
                            <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                        src="static.joonsite.com/storage/21443/media/2404241337318007d755.png?class=thumb"
                                        alt=""></a></div>
                            <div class="fontStyle4 mg-0 theme-listTitle"><span class="jwset">
                                    <p><span style="color:var(--color6);"><strong>Convenience</strong></span></p>
                                </span></div>
                            <div class="fontStyle7 mg-1 theme-listSubtitle">Diagnomitra brings the lab to your doorstep,
                                prioritizing ease and comfort in your health check-ups.</div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="column-item text-center text-lg-start">
                            <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                        src="static.joonsite.com/storage/21443/media/2404241339468422d755.png?class=thumb"
                                        alt=""></a></div>
                            <div class="fontStyle4 mg-0 theme-listTitle"><span class="jwset">
                                    <p><span style="color:var(--color6);"><strong>Personalized
                                                Experience</strong></span></p>
                                </span></div>
                            <div class="fontStyle7 mg-1 theme-listSubtitle">With personalized experiences, we prioritize
                                individual health needs, guiding patients seamlessly through their diagnostic process.
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="column-item text-center text-lg-start">
                            <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                        src="static.joonsite.com/storage/21443/media/2404291521254353d755.png?class=thumb"
                                        alt=""></a></div>
                            <div class="fontStyle4 mg-0 theme-listTitle"><span class="jwset">
                                    <p><span style="color:var(--color6);"><strong>Compare prices of 100+
                                                Labs</strong></span></p>
                                </span></div>
                            <div class="fontStyle7 mg-1 theme-listSubtitle">Get the most competitive rates by comparing
                                prices across a wide range of over 100 laboratories</div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="column-item text-center text-lg-start">
                            <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                        src="static.joonsite.com/storage/21443/media/2404291515002059d755.png?class=thumb"
                                        alt=""></a></div>
                            <div class="fontStyle4 mg-0 theme-listTitle"><span class="jwset">
                                    <p><span style="color:var(--color6);"><strong>Free Sample collection on
                                                time</strong></span></p>
                                </span></div>
                            <div class="fontStyle7 mg-1 theme-listSubtitle">Prompt and precise, our service ensures free
                                sample collection right on schedule, every time</div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="column-item text-center text-lg-start">
                            <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                        src="static.joonsite.com/storage/21443/media/2404291518212566d755.png?class=thumb"
                                        alt=""></a></div>
                            <div class="fontStyle4 mg-0 theme-listTitle"><span class="jwset">
                                    <p><span style="color:var(--color6);"><strong>Choose test by
                                                symptoms</strong></span></p>
                                </span></div>
                            <div class="fontStyle7 mg-1 theme-listSubtitle">Select the appropriate medical test based on
                                the specific signs and indications presented by the patient</div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="column-item text-center text-lg-start">
                            <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                        src="static.joonsite.com/storage/21443/media/2404291516104509d755.png?class=thumb"
                                        alt=""></a></div>
                            <div class="fontStyle4 mg-0 theme-listTitle"><span class="jwset">
                                    <p><span style="color:var(--color6);"><strong>Book test for family &amp;
                                                friend</strong></span></p>
                                </span></div>
                            <div class="fontStyle7 mg-1 theme-listSubtitle">Discover your family&#39;s health story with
                                our comprehensive book test for family and friends, offered through our trusted medical
                                test lab platforms.</div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="column-item text-center text-lg-start">
                            <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                        src="static.joonsite.com/storage/21443/media/2404291519592017d755.png?class=thumb"
                                        alt=""></a></div>
                            <div class="fontStyle4 mg-0 theme-listTitle"><span class="jwset">
    ...
    <section class="testimonial padding-4 " id="testimonials_7"
        style="background-image:linear-gradient(rgba(0,0,0,.1),rgba(0,0,0,.1)),url(static.joonsite.com/storage/2132/media/medical-bg.jpg);background-size:cover;background-repeat:no-repeat;margin-bottom:0;background-position:center;">
        <div class="container">
            ...
            <div class="testimonial-slider">
                    ...
                    <div class="testimonial_box-bottom">
                        <div class="testimonial_box-profile">
                            <div class="testimonial_box-img"><a href="javascript:void(0);"><img
                                        src="static.joonsite.com/storage/21443/media/2405081121352593d755.png?class=thumb"
                                        alt=""></a></div>
                ...
                <div class="testimonial-slide  content-padding px-3 text-center text-lg-start">
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">Thanks to Diagnomitra&#39;s pharmacy solutions, I
                                no longer have to worry about running out of medicines. The delivery service is a
                                game-changer.</div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                    ...
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">Diagnomitra&#39;s insurance assistance was
                                invaluable. They guided me through the entire process and ensured I got the coverage I
                                needed.</div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                        <div class="testimonial_box-profile">
                            <div class="testimonial_box-img"><a href="javascript:void(0);"><img
                                        src="static.joonsite.com/storage/21443/media/2405081127513864d755.png?class=thumb"
                                        alt=""></a></div>
                            <div class="testimonial_box-info">
                                <div class="testimonial_box-name">
                ...
                <div class="testimonial-slide  content-padding px-3 text-center text-lg-start">
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">I recently underwent surgery with Diagnomitra, and
                                I couldn&#39;t have asked for better care. The entire process was smooth and comforting.
                            </div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                ...
                <div class="testimonial-slide  content-padding px-3 text-center text-lg-start">
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">I&#39;m extremely satisfied with Diagnomitra&#39;s
                                blood test booking service. It&#39;s efficient, reliable, and affordable.</div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                        <div class="testimonial_box-profile">
                ...
                <div class="testimonial-slide  content-padding px-3 text-center text-lg-start">
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">Diagnomitra&#39;s insurance support team helped me
                                understand my policy better and made the claim process smooth.</div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                        <div class="testimonial_box-profile">
                    ...
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">The radiology services at Diagnomitra were
                                impressive. I got my X-ray done without any hassle, and the results were accurate.</div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                        <div class="testimonial_box-profile">
                ...
                <div class="testimonial-slide  content-padding px-3 text-center text-lg-start">
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">I never thought booking a blood test could be this
                                simple. Diagnomitra&#39;s platform is user-friendly and efficient.</div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                        <div class="testimonial_box-profile">
                    ...
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">Diagnomitra&#39;s pharmacy solutions are a
                                lifesaver! I can get my medicines delivered right to my doorstep, making my life much
                                easier.</div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                    ...
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">The insurance support team at Diagnomitra made
                                understanding my insurance coverage so much easier. Thank you for your guidance!</div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                        <div class="testimonial_box-profile">
                ...
                <div class="testimonial-slide  content-padding px-3 text-center text-lg-start">
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">I had surgery through Diagnomitra, and I must say,
                                their surgical team is top-notch. I felt safe and well taken care of throughout.</div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                        <div class="testimonial_box-profile">
                    ...
                    <div class="col-md-8 flex-grow-1">
                        <div class="row gy-4 background3 p-5 border-radius-2">
                            <div class="col-12 col-sm-6 col-md-4">
                                <div class="column-item text-center text-lg-start">
                                    <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                                src="static.joonsite.com/storage/21443/media/2404301228566913d755.png?class=thumb"
                                                alt=""></a></div>
                            ...
                            <div class="col-12 col-sm-6 col-md-4">
                                <div class="column-item text-center text-lg-start">
                                    <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                                src="static.joonsite.com/storage/21443/media/2404301229509371d755.png?class=thumb"
                                                alt=""></a></div>
                                    ...
                                    <div class="fontStyle7 mg-1 theme-listSubtitle">Easily locate the most competitive
                                        test prices by filtering based on test names and your city.</div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-4">
                                <div class="column-item text-center text-lg-start">
                                    <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                                src="static.joonsite.com/storage/21443/media/2404301231240875d755.png?class=thumb"
                                                alt=""></a></div>
                                    <div class="fontStyle4 mg-0 theme-listTitle"><span class="jwset"><span
                                                style="color:var(--color6);"><strong>Select Labs</strong></span></span>
                                    </div>
                                    <div class="fontStyle7 mg-1 theme-listSubtitle">Filter labs based on distance and
                                        pricing, ensuring personalized options aligning with your preferences.</div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-4">
                                <div class="column-item text-center text-lg-start">
                                    <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                                src="static.joonsite.com/storage/21443/media/2404301234217443d755.png?class=thumb"
                                                alt=""></a></div>
                                    <div class="fontStyle4 mg-0 theme-listTitle"><span class="jwset"><span
                            ...
                            <div class="col-12 col-sm-6 col-md-4">
                                <div class="column-item text-center text-lg-start">
                                    <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                                src="static.joonsite.com/storage/21443/media/2404301240053201d755.png?class=thumb"
                                                alt=""></a></div>
                                    <div class="fontStyle4 mg-0 theme-listTitle"><span class="jwset"><span
                                                style="color:var(--color6);"><strong>Book a Time
                                                    Slot</strong></span></span></div>
                                    <div class="fontStyle7 mg-1 theme-listSubtitle">Choose a convenient time slot for
                                        home sample collection, ensuring minimal disruption to your schedule.</div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-4">
                                <div class="column-item text-center text-lg-start">
                                    <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                                src="static.joonsite.com/storage/21443/media/2404301243187706d755.png?class=thumb"
                                                alt=""></a></div>
                                    <div class="fontStyle4 mg-0 theme-listTitle"><span class="jwset"><span
                                    ...
                                    <div class="fontStyle7 mg-1 theme-listSubtitle">Enjoy the flexibility of prepaid
                                        options (card, UPI, net banking) or choose postpaid (cash) after the home sample
                                        collection.</div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-4">
                                <div class="column-item text-center text-lg-start">
                                    <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                                src="static.joonsite.com/storage/21443/media/2404301244413250d755.png?class=thumb"
                                                alt=""></a></div>
                                    <div class="fontStyle4 mg-0 theme-listTitle"><span class="jwset"><span
                                                style="color:var(--color6);"><strong>Family &amp;
                                                    Friends</strong></span></span></div>
                                    <div class="fontStyle7 mg-1 theme-listSubtitle">Enhance your user profile by adding
                                        multiple family and friends, facilitating seamless test bookings for your loved
                                        ones.</div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-4">
                                <div class="column-item text-center text-lg-start">
                                    <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                                src="static.joonsite.com/storage/21443/media/2404301245159625d755.png?class=thumb"
                                                alt=""></a></div>
                                    <div class="fontStyle4 mg-0 theme-listTitle"><span class="jwset"><span
                                                style="color:var(--color6);"><strong>Reports</strong></span></span>
                                    </div>
                                    <div class="fontStyle7 mg-1 theme-listSubtitle">Upon completion, test reports will
                                        be securely available on the Diagnomitra platform for easy download.</div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-4">
                                <div class="column-item text-center text-lg-start">
                                    <div class="column-icon-media mg-1"><a href="javascript:void(0);"><img
                                                src="static.joonsite.com/storage/21443/media/2404301249198797d755.png?class=thumb"
                                                alt=""></a></div>
                                    <div class="fontStyle4 mg-0 theme-listTitle"><span class="jwset"><span
                                                style="color:var(--color6);"><strong>History</strong></span></span>
                                    </div>
                                    <div class="fontStyle7 mg-1 theme-listSubtitle">All the payment related information
                                        along with test name, patient name will be available here.</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="testimonial padding-4 background6" id="testimonials_9"
        style="background-image:linear-gradient(rgba(0,0,0,.1),rgba(0,0,0,.1)),url(static.joonsite.com/storage/21443/media/2405131659147901.png);background-size:cover;background-repeat:no-repeat;margin-bottom:0;background-position:center;">
        <div class="container">
            <div class="box-top text-center text-lg-center content-padding">
                <div class="title fontStyle3 theme-title">Recomendation <span style="color:var(--color3);">From</span>
                    <span style="color:var(--color4);">Doctors</span></div>
            </div>
            <div class="testimonial-slider">
                    ...
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">I recommend Diagnomitra for its user-friendly
                                interface and comprehensive healthcare services. It&#39;s a one-stop solution for all
                                your medical needs.</div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                        <div class="testimonial_box-profile">
                            <div class="testimonial_box-img"><a href="javascript:void(0);"><img
                                        src="static.joonsite.com/storage/21443/media/2405131721177033d755.png?class=thumb"
                                        alt=""></a></div>
                            <div class="testimonial_box-info">
                                <div class="testimonial_box-name">
                ...
                <div class="testimonial-slide  content-padding px-3 text-center text-lg-center">
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">I trust Diagnomitra for its efficient blood test
                                booking system, ensuring accuracy and timely results for my patients.</div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                        <div class="testimonial_box-profile">
                ...
                <div class="testimonial-slide  content-padding px-3 text-center text-lg-center">
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">I endorse Diagnomitra for its efficient insurance
                                assistance, helping patients navigate the complexities of healthcare financing.</div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                        <div class="testimonial_box-profile">
                            <div class="testimonial_box-img"><a href="javascript:void(0);"><img
                                        src="static.joonsite.com/storage/21443/media/2405131721340220d755.png?class=thumb"
                                        alt=""></a></div>
                            <div class="testimonial_box-info">
                                <div class="testimonial_box-name">
                ...
                <div class="testimonial-slide  content-padding px-3 text-center text-lg-center">
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">Using Diagnomitra ensures timely access to medical
                                services like blood tests, radiology, and surgeries, which is crucial for maintaining
                                good health.</div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                ...
                <div class="testimonial-slide  content-padding px-3 text-center text-lg-center">
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">Diagnomitra&#39;s streamlined process for booking
                                appointments and accessing medical records makes healthcare management easier for
                                patients.</div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                ...
                <div class="testimonial-slide  content-padding px-3 text-center text-lg-center">
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">Using Diagnomitra is beneficial for patients as it
                                offers a wide range of healthcare services under one umbrella, saving time and effort.
                            </div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                    ...
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">I recommend Diagnomitra to my patients for its
                                commitment to surgical excellence and access to top-tier surgeons and facilities.</div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                        <div class="testimonial_box-profile">
                    ...
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">Diagnomitra&#39;s radiology services are
                                top-notch, providing advanced diagnostics with minimal wait time, which is crucial for
                                early detection.</div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                    ...
                    <div class="testimonial_box-top">
                        <div class="testimonial_box-text">
                            <div class="para fontStyle7 content_data">
                                <p>Patients should use Diagnomitra for its holistic approach to healthcare, offering all
                                    medical solutions under one platform for their convenience.</p>
                            </div>
                        </div>
                    </div>
                    <div class="testimonial_box-bottom">
                        ...
                        <div class="accordion" id="accordionExamplefaq_10">
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One0"><button
                                        ...
                                        aria-expanded="true" aria-controls="collapseOne"> <span class="jwset">Q1. How do
                                            I register with Diagnomitra?</span></button></h2>
                                <div id="collapsefaq_10One0" class="accordion-collapse collapse show fontStyle8 "
                                    ...
                                    <div class="accordion-body content_data">Visit our app, enter your number and follow
                                        the simple registration process.</div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One1"><button
                                        ...
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q2. Is my
                                            personal information kept confidential?</span></button></h2>
                                <div id="collapsefaq_10One1" class="accordion-collapse collapse  fontStyle8 "
                                    ...
                                    <div class="accordion-body content_data">Diagnomitra prioritizes user privacy. Your
                                        personal information and test results are stored securely, adhering to strict
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One2"><button
                                        ...
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q3. Are
                                            the Partnered labs certified?</span></button></h2>
                                <div id="collapsefaq_10One2" class="accordion-collapse collapse  fontStyle8 "
                                    ...
                                    <div class="accordion-body content_data">Yes, all labs on our platform are certified
                                        and licensed by the Government of India.</div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One3"><button
                                        ...
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q4. Do
                                            you offer discounts for bulk bookings or corporate health
                                ...
                                <div id="collapsefaq_10One3" class="accordion-collapse collapse  fontStyle8 "
                                    ...
                                    <div class="accordion-body content_data">Diagnomitra provides special packages for
                                        bulk bookings and corporate health&nbsp; programs. Contact our support team for
                                        personalized assistance.</div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One4"><button
                                        ...
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q5. What
                                            happens if I miss my home sample collection appointment?</span></button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One5"><button
                                        ...
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q6. Can I
                                            book test for family mambers?</span></button></h2>
                                <div id="collapsefaq_10One5" class="accordion-collapse collapse  fontStyle8 "
                                    ...
                                    <div class="accordion-body content_data">Absolutely! Diagnomitra allows you to add
                                        multiple family and friends to your profile.</div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One6"><button
                                        ...
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q7. What
                                            payment options are available?</span></button></h2>
                                <div id="collapsefaq_10One6" class="accordion-collapse collapse  fontStyle8 "
                                    ...
                                    <div class="accordion-body content_data">Choose from prepaid options (card, UPI, net
                                        banking) or postpaid (cash) after home<br />
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One7"><button
                                        ...
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q8. How
                                            is the accuracy of the test reports ensured?</span></button></h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One8"><button
                                        ...
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q9. How
                                            soon can&nbsp;I expect my test results after the sample
                                ...
                                <div id="collapsefaq_10One8" class="accordion-collapse collapse  fontStyle8 "
                                    ...
                                    <div class="accordion-body content_data">Test result turnaround times may vary based
                                        on the type of test. You can check the<br />
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One9"><button
                                        ...
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q10. How
                                            do I download my test reports?</span></button></h2>
                                <div id="collapsefaq_10One9" class="accordion-collapse collapse  fontStyle8 "
                                    ...
                                    <div class="accordion-body content_data">Upon completion, your test reports will be
                                        securely available on the Diagnomitra<br />
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One10"><button
                                        class="accordion-button fontStyle4 theme-listTitle background1" id="faq_10"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#collapsefaq_10One10"
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q11. Is
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One11"><button
                                        class="accordion-button fontStyle4 theme-listTitle background1" id="faq_10"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#collapsefaq_10One11"
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q12. Can
                                            I reschedule my home sample collection?</span></button></h2>
                                <div id="collapsefaq_10One11" class="accordion-collapse collapse  fontStyle8 "
                                    ...
                                    <div class="accordion-body content_data">Yes, you can reschedule your home sample
                                        collection by accessing your booking details<br />
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One12"><button
                                        class="accordion-button fontStyle4 theme-listTitle background1" id="faq_10"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#collapsefaq_10One12"
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q13. What
                                            COVID-19 tests does Diagnomitra&nbsp;offer?</span></button></h2>
                                <div id="collapsefaq_10One12" class="accordion-collapse collapse  fontStyle8 "
                                    ...
                                    <div class="accordion-body content_data">Visit our app, enter your number and follow
                                        the simple registration process.Diagnomitra provides a range of COVID-19 tests,
                                        including RT-PCR, antigen, and<br />
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One13"><button
                                        class="accordion-button fontStyle4 theme-listTitle background1" id="faq_10"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#collapsefaq_10One13"
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q14. What
                                            COVID-19 safety measures are in place during home sample
                                            collection?</span></button></h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One14"><button
                                        class="accordion-button fontStyle4 theme-listTitle background1" id="faq_10"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#collapsefaq_10One14"
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q15. Can
                                            I book a test for someone else using my account?</span></button></h2>
                                <div id="collapsefaq_10One14" class="accordion-collapse collapse  fontStyle8 "
                                    ...
                                    <div class="accordion-body content_data">Yes, Diagnomitra allows you to book tests
                                        for family and friends. You can add their<br />
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One15"><button
                                        class="accordion-button fontStyle4 theme-listTitle background1" id="faq_10"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#collapsefaq_10One15"
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q16. Are
                                            there any additional charges for home sample collection?</span></button>
                                </h2>
                                <div id="collapsefaq_10One15" class="accordion-collapse collapse  fontStyle8 "
                                    ...
                                    <div class="accordion-body content_data">No, home sample collection is included in
                                        the overall test booking cost. There are no<br />
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One16"><button
                                        class="accordion-button fontStyle4 theme-listTitle background1" id="faq_10"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#collapsefaq_10One16"
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q17. Are
                                            the home sample collection professionals qualified and
                                            trained?</span></button></h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One17"><button
                                        class="accordion-button fontStyle4 theme-listTitle background1" id="faq_10"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#collapsefaq_10One17"
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q18. Can
                                            I track the status of my test processing?</span></button></h2>
                                <div id="collapsefaq_10One17" class="accordion-collapse collapse  fontStyle8 "
                                    ...
                                    <div class="accordion-body content_data">Yes, you can track the status of your test
                                        processing through your Diagnomitra account.<br />
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One18"><button
                                        class="accordion-button fontStyle4 theme-listTitle background1" id="faq_10"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#collapsefaq_10One18"
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q19. What
                                            do I do if I have a concerns about my test results?</span></button></h2>
                                <div id="collapsefaq_10One18" class="accordion-collapse collapse  fontStyle8 "
                                    ...
                                    <div class="accordion-body content_data">If you have any concerns about your test
                                        results, contact our customer support team.<br />
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One19"><button
                                        class="accordion-button fontStyle4 theme-listTitle background1" id="faq_10"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#collapsefaq_10One19"
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q20. Can
                                            I cancel a test booking?</span></button></h2>
                                <div id="collapsefaq_10One19" class="accordion-collapse collapse  fontStyle8 "
                                    ...
                                    <div class="accordion-body content_data">For any queries about canceling a test
                                        booking, just drop email at help@diagnomitra.com. We&#39;re here to help, and
                                        we&#39;ll get back to you in a flash!</div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingfaq_10One20"><button
                                        class="accordion-button fontStyle4 theme-listTitle background1" id="faq_10"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#collapsefaq_10One20"
                                        aria-expanded="false" aria-controls="collapseOne"> <span class="jwset">Q21. Can
                                            I change the lab after booking a test?</span></button></h2>
    ...
    <section class="welcome_2 background5" id="welcome-form_11">
        <div class="full-width" style="position:relative">
                ...
                <div class="row gy-4 justify-content-center align-items-center flex-row">
                    <div class="col-12 col-sm-12 col-md-6">
                        <div class="row welcome_form_row">
                            <div class="contactRight contactRight_1 py-3 px-4 background2">
                                <div class="header_stylee content-padding text-center">
                                    <div class="main-title fontStyle3 my-2 theme-formTitle">Need Assistance With Booking
                                    </div>
                                </div>
                                <ul class="fontStyle9 ps-0">
                                    <form class="jw_dynamic_form" name="form_v_11">
                                        ...
                                        <li class="dynamicField" data-input="tel" data-mode="system"><label>Mobile
                                                ...
                                                date-mode="system" data-input="tel" class="jw_dynamic_input " tooltip=""
                                                placeholder="Enter Number" maxlength="100" errmsg="" required></li>
                    ...
                    <div class="col-12 col-sm-12 col-md-6">
                        <div class="text-center text-lg-center">
                            <div class="about-title fontStyle2 mb-3 theme-title"><span class="jwset">&nbsp;</span></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="fade_22 p-0">
                    <div class="slide_img_2"><img
                            src="static.joonsite.com/storage/21443/media/2405131437090953d755.png?class=thumb" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="about-row d-flex flex-wrap flex-row-reverse align-items-center">
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <figure class="media-fit"><a href="javascript:void(0);"><img class=""
                                src="static.joonsite.com/storage/21443/media/2404291534401628.webp" alt=""></a></figure>
                </div>
                ...
                <div class="col-sm-6 d-flex flex-column justify-content-center flex-grow-1">
                    ...
                    <div class="banner2-form2 p-4 fontStyle7">
                        <form class="jw_dynamic_form" name="form_v_14">
                            <signature style="display:none">W10=</signature>
                            <li class="dynamicField" data-input="text" data-mode="system"><label>Full Name</label><input
                                    type="text" data-name="firstName" date-mode="system" data-input="text"
                                    class="jw_dynamic_input " tooltip="" placeholder="Enter Name" maxlength="100"
                                    errmsg="" required></li>
                            <li class="dynamicField" data-input="email" data-mode="system"><label>Email</label><input
                                    type="email" data-name="email" date-mode="system" data-input="email"
                                    class="jw_dynamic_input " tooltip="" placeholder="Enter Your Email" maxlength="100"
                                    errmsg="" required></li>
                            <li class="dynamicField" data-input="tel" data-mode="system"><label>Mobile
                            ...
                            <li class="dynamicField" data-input="text" data-mode="system"><label>Your
                                    ...
                                    data-input="text" class="jw_dynamic_input " tooltip="" placeholder="Enter Location"
                                    maxlength="100" errmsg="" required></li>
    ...
    <script>
    // Timeout function to remove success message after 2 seconds
    setTimeout(function() {
