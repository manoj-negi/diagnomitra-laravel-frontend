...
<title>Privacy Policy | diagnomitra</title>
...
<body>
@include('header')
       <section id="system-policies_1" class="privacy_policy see-section  see-light-color  "><div class="see-full jw-full"><div class="see-width jw-width"><div class="privacy-wrapper see-full jw-full"><div class="heading see_title em_system-policies_1_title privacy-policy-heading" >Privacy Policy</div><div class="content-div"><div class="desp para "><ol><li><strong>Introduction</strong></li></ol><p>We, at Diagnomitra HealthCare LLP (hereinafter referred to as &ldquo;Diagnomitra.com&rdquo;), are committed to respecting your online privacy and recognize the need for appropriate protection and management of any personally identifiable information you share with us. This Privacy Policy (&ldquo;Policy&rdquo;) describes how Diagnomitra.com collects, uses, discloses and transfers personal information of users through its websites and applications, including through Diagnomitra.com, mobile applications and online services (collectively, the &ldquo;Platform&rdquo;). This policy applies to those who visit the Platform, or whose information Diagnomitra.com otherwise receives in connection with its services (such as contact information of individuals associated with Diagnomitra.com including partners) (hereinafter collectively referred to as &ldquo;Users&rdquo;). For the purposes of the Privacy Policy, &ldquo;You&rdquo; or &ldquo;Your&rdquo; shall mean the person who is accessing the Platform.</p><p><strong>This Privacy Policy is published in compliance with, inter alia: Section 43A of the Information Technology Act, 2000; Regulation 4 of the Information Technology (Reasonable Security Practices and Procedures and Sensitive Personal Information) Rules, 2011 (the &ldquo;SPI Rules&rdquo;); Regulation 3(1) of the Information Technology (Intermediaries Guidelines) Rules, 2011.</strong></p><p>&nbsp;</p><ol><li><strong>Types of Personal Information collected by Diagnomitra.com</strong></li></ol><p>&ldquo;Personal information&rdquo; (PI) &ndash; means any information relating to an identified or identifiable natural person including common identifiers such as a name, an identification number, location data, an online identifier or one or more factors specific to the physical, physiological, genetic, mental, economic, cultural or social identity of that natural person and any other information that is so categorized by applicable laws. We collect information about you and/or your usage to provide better services and offerings.</p><p>The Personal Information that we collect, and how we collect it, depends upon how you interact with us. We collect the following categories of Sensitive Personal Information in the following ways:</p><ol><li>When your register with us we collect your name, contact data (such as your email address and phone number); demographic data (such as your gender, your date of birth and your pin code); medical history data regarding your usage of the services and history of the appointments made by or with you through the use of our Services; medical insurance data (such as your insurance carrier and insurance plan); other information that you voluntarily choose to provide to us (such as information shared by you with us through emails or letters.)</li><li>The information collected from you by Diagnomitra.com may constitute &lsquo;personal information&rsquo; or &lsquo;sensitive personal data or information&rsquo; under the SPI Rules. The SPI Rules further define &ldquo;Sensitive Personal Data or Information&rdquo; of a person to mean personal information about that person relating to:</li></ol><p>passwords; financial information such as bank accounts, credit and debit card details or other payment instrument details; physical, physiological and mental health condition; sexual orientation; medical records and history; biometric information; information received by body corporate under lawful contract or otherwise; visitor details as provided at the time of registration or thereafter; and call data records.</p><ol><li>Diagnomitra.com will be free to use, collect and disclose information that is freely available in the public domain without your consent.</li><li>information about the services that you use and how you use them, including log information and location information, when you are a user of the services through the Platform;</li><li>we may collect your Personal Information such as name, age, contact details, preferences, etc. through surveys and forms, when you choose to participate in these surveys etc.;</li><li>when you communicate with Diagnomitra.com, we collect information about your communication and any information you choose to provide;</li><li>when you visit the Platform, we use cookies to automatically collect, store and use technical information about your system and interaction with our Platform;</li><li>when you use a device to access the Platform, Diagnomitra.com may collect technical or other related information from the device as well as the device location;</li></ol><p>To the extent permitted by law, Diagnomitra.com may record and monitor your communications with us to ensure compliance with our legal and regulatory obligations and our internal policies. This may include the recording of telephone conversations;</p><p>&nbsp;</p><ol><li><strong>How Diagnomitra.com may use your Personal Information</strong></li></ol><p>We will only use your personal data in a fair and reasonable manner, and where we have a lawful reason to do so.</p><p>Our use of your personal data depends on the purpose for which you interact with us. We may process your Personal Information for the following purposes:</p><p>&nbsp;</p><ol><li>Providing our services and products to you including to send you related alerts, calendar alerts, relevant search results and other recommendations facilities;</li><li>Protecting our Users and providing you with customer support;</li><li>We use information collected from cookies and other technologies, to improve your user experience and the overall quality of our services (for more information please refer to paragraph 4 below). When showing you tailored ads, we will not associate an identifier from cookies or similar technologies with sensitive categories, such as those based on race, religion, sexual orientation or health.</li><li>Improving the Platform and its content to provide better features and services.</li><li>Conducting market research and surveys with the aim of improving our products and services.</li><li>Sending you information about our products and services for marketing purposes and promotions;</li><li>Preventing, detecting, investigating and taking action against crimes (including but not limited to fraud and other financial crimes), any other illegal activities, suspected fraud, or violations of Diagnomitra.com&rsquo;s Terms of Use in any jurisdiction.</li><li>To the extent required for identity verification, government sanctions screening and due diligence checks.</li><li>Establishing, exercising or defending legal rights in connection with legal proceedings (including any prospective legal proceedings) and seeking professional or legal advice in relation to such legal proceedings.</li><li><strong>Cookies and Other Tracking Technologies</strong></li></ol><p>Some of our web pages utilize &ldquo;cookies&rdquo; and other tracking technologies. A &ldquo;cookie&rdquo; is a small text file that may be used, for example, to collect information about web-site activity. Some cookies and other technologies may serve to recall Personal Information previously indicated by a user. Most browsers allow you to control cookies, including whether or not to accept them and how to remove them.</p><p>You may set most browsers to notify you if you receive a cookie, or you may choose to block cookies with your browser, but please note that if you choose to erase or block your cookies, you will need to re-enter your original user ID and password to gain access to certain parts of the Platform.</p><p>Tracking technologies may record information such as Internet domain and host names; Internet protocol (IP) addresses; browser software and operating system types; clickstream patterns; and dates and times that our site is accessed. Our use of cookies and other tracking technologies allows us to improve our Platform and the overall website experience. We may also analyze information that does not contain Personal Information for trends and statistics.</p><p>&nbsp;</p><p>For more information about our use of cookies please refer to our Cookie Policy.</p><p>&nbsp;</p><ol><li><strong>The Basis/ Grounds which we rely on for collection and processing of your Personal Information:</strong></li></ol><p>Your Personal Information is collected and processed by Diagnomitra.com based on the following legal grounds depending upon the nature of Personal Information and the purposes for which it is processed.</p><p><strong>Consent:</strong></p><p>Diagnomitra.com relies on your consent in order to process your Personal Information in certain situations. If Diagnomitra.com requires your consent to collect and process certain Personal Information, as per the requirements under the applicable data protection laws, your consent is sought at the time of collection of your Personal Information and such processing will only be performed where consent is secured.</p><p><strong>Compliance with a legal obligation:</strong></p><p>Your Personal Information may be processed by Diagnomitra.com, to the extent that such processing is necessary to allow Diagnomitra.com to comply with a legal obligation. An example of this would be if Diagnomitra.com is required to disclose your Personal Information to respond to a court order or if Diagnomitra.com is required to retain specific records for a fixed period to comply with requirements under any applicable law.</p><p>&nbsp;</p><ol><li><strong>Information Sharing and Disclosure</strong></li></ol><p>Diagnomitra.com does not disclose, transfer or share your Personal Information with others except with:</p><p>Our affiliates and group companies to the extent required for our internal business and/or administrative purposes and/or general corporate operations and for provision of services aimed at helping you and improve our services;</p><p>Third parties including enforcement, regulatory and judicial authorities, if we determine that disclosure of your Personal Information is required to a) respond to subpoenas, court orders, or legal process, or to establish or exercise our legal rights or defend against legal claims; or b) investigate, prevent, or take action regarding illegal activities, suspected fraud, situations involving potential threats to the physical safety of any person, violations of Diagnomitra.com&rsquo;s Terms of Use or as otherwise required by law;</p><p>In the event of a merger, acquisition, financing, or sale of assets or any other situation involving the transfer of some or all of Diagnomitra.com&rsquo;s business assets we may disclose Personal Information to those involved in the negotiation or transfer.</p><p>Third party service providers and marketing partners that Diagnomitra.com engages to a) provide services over the Platform on Diagnomitra.com&rsquo;s behalf; b) maintain the Platform and mailing lists; or c) communicate with you on Diagnomitra.com&rsquo;s behalf about offers relating to its products and/or services. Diagnomitra.com will take reasonable steps to ensure that these third-party service providers are obligated to protect your Personal Information and are also subject to appropriate confidentiality / non-disclosure obligations.</p><p>The Company does not provide any Personal Information to the advertiser when you interact with or view a targeted advertisement. However, if you interact with or view an advertisement, the advertiser may make certain assumptions and, in the process, learn certain Personal Information about you. For instance, if you view and click an advertisement that is targeted towards women in the age group 18- 24 from a specific geographic area, the advertiser may assume that you meet the relevant criteria.</p><p>Diagnomitra.com does not intend to transfer Personal Information without your consent to third parties who are not bound to act on Diagnomitra.com&rsquo;s behalf unless such transfer is legally required.</p><p>If your Personal Information is transferred outside India, we take the necessary steps to protect your Personal Information in accordance with applicable data protection laws.</p><p>&nbsp;</p><p>&nbsp;</p><ol><li><strong>Third Party Content:</strong></li></ol><p>Please be aware that the Platform sometimes may contain links to other sites that are not governed by this Privacy Policy. Users may be directed to third-party sites for more information, such as advertisers, blogs, content sponsorships, vendor services, social networks, etc.</p><p>&nbsp;</p><p>Diagnomitra.com makes no representations or warranties regarding how your information is stored or used on third-party servers. We recommend that you review the applicable privacy statements and policies of each third-party site linked from the Platform to determine their use of your personal information.</p><p>&nbsp;</p><ol><li><strong>Children Information</strong></li></ol><p>Use of our Platform is available only to persons who can form a legally binding contract under the Indian Contract Act, 1872. We do not knowingly solicit or collect personal information from children under the age of 18 years. If you have shared any personal information of children under the age of 18 years, you represent that you have the authority to do so and permit us to use the information in accordance with this Privacy Policy. If you are under the age of 18 or the age of majority in your jurisdiction, you must use the Platform under the supervision of your parent, legal guardian or responsible adult.</p><p>&nbsp;</p><ol><li><strong>Retention of Personal Information</strong></li></ol><p>We retain your personal information in accordance with applicable laws, for a period no longer than is required for the purpose for which it was collected or as required under any applicable law. However, we may retain data related to you if we believe it may be necessary to prevent fraud or future abuse, to enable Diagnomitra.com to exercise its legal rights and/or defend against legal claims or if required by law or for other legitimate purposes.</p><p>We may continue to retain your data in anonymised form for analytical and research purposes.</p><p>&nbsp;</p><ol><li><strong>Controlling your personal information</strong></li></ol><p>You have the right to invoke your rights which are available to data principals or data subjects (as per applicable laws and regulations) in relation to your Personal Information which is being processed by Diagnomitra.com.</p><p>Diagnomitra.com provides you the ability to keep your Personal Information accurate and up-to-date. If at any time you would like to a) rectify, update or correct your Personal Information; b) obtain confirmation on whether or not your Personal Information is processed by it; c) access your Personal Information or exercise your right to data portability; or d) exercise your right to restrict the continuing disclosure of your Personal Information to any third party by Diagnomitra.com in certain circumstances, you are requested to contact us using the contact details mentions in paragraph 14 below. We will require you to provide a valid proof of your identity, in order to ensure that your rights are respected. For the exercise of certain rights, you may be required to approach the relevant authority / designated officer as per the provisions of the applicable data protection laws, Diagnomitra.com may in accordance with the provisions of applicable data protection laws, charge a fee for fulfilling your request, in particular in case of excessive or manifestly unfounded request. Further you acknowledge that the above mentioned rights are not absolute and are subject to limitations as per the applicable data protection laws.</p><p>At any time, if you wish to delete your account on Diagnomitra.com it can be initiated by raising a request with our call center and necessary action for deletion of user account will be taken by us.</p><p>&nbsp;</p><ol><li><strong>Confidentiality and Security</strong></li></ol><p>The security and confidentiality of your Personal Information is important to us and Diagnomitra.com has invested significant resources to protect the safekeeping and confidentiality of your personal data. When using external service providers acting as processors, we require that they adhere to the same standards as Diagnomitra.com does. Regardless of where your Personal Information is transferred or stored, we take all steps reasonably necessary to ensure that personal data is kept secure.</p><p>We seek to ensure compliance with the requirements of the Information Technology Act, 2000 and Rules made there under to ensure the protection and preservation of your privacy. We have physical, electronic, and procedural safeguards that comply with the laws prevalent in India to protect your Personal Information. By accepting the terms of this Privacy Policy, you agree that the standards and practices being implemented by us, are reasonable and sufficient for the protection of your Personal Information.</p><p>Your Personal Information is maintained by Diagnomitra.com in electronic form on its equipment, and on the equipment of its employees. Such information may also be converted to physical form from time to time. Diagnomitra.com takes all necessary precautions to protect your personal information both online and off-line, and implements reasonable security practices and measures including certain managerial, technical, operational and physical security control measures that are commensurate with respect to the information being collected and the nature of Diagnomitra.com&rsquo;s business.</p><p>No administrator at Diagnomitra.com will have knowledge of your password. It is important for you to protect against unauthorized access to your password, your computer and your mobile phone. Be sure to log off from the Website when finished. Diagnomitra.com does not undertake any liability for any unauthorised use of your account and password. If you suspect any unauthorized use of your account, you must immediately notify Diagnomitra.com by sending an email to customercare@Diagnomitra.com. You shall be liable to indemnify Diagnomitra.com due to any loss suffered by it due to such unauthorized use of your account and password.</p><p>Diagnomitra.com makes all User information accessible to its employees, agents or partners and third parties only on a need-to-know basis, and binds only its employees to strict confidentiality obligations.</p><p>&nbsp;</p><p>Part of the functionality of Diagnomitra.com is assisting the doctors to maintain and organise such information. Diagnomitra.com may, therefore, retain and submit all such records to the appropriate authorities, or to doctors who request access to such information.</p><p>Part of the functionality of the Diagnomitra.com is assisting the patients to access information relating to them. Diagnomitra.com may, therefore, retain and submit all such records to the relevant patients, or to their doctors.</p><p>Notwithstanding the above, Diagnomitra.com is not responsible for the confidentiality, security or distribution of your Personal Information by our partners and third parties outside the scope of our agreement with such partners and third parties. Further, Diagnomitra.com shall not be responsible for any breach of security or for any actions of any third parties or events that are beyond the reasonable control of Diagnomitra.com including but not limited to, acts of government, computer hacking, unauthorised access to computer data and storage device, computer crashes, breach of security and encryption, poor quality of Internet service or telephone service of the User etc.</p><p>&nbsp;</p><ol><li><strong>Social Media</strong></li></ol><p>Diagnomitra.com may operate channels, pages and accounts on some social media sites to inform, assist and engage with customers. Diagnomitra.com monitors and records comments and posts made on these channels about itself in order to improve its products and services. Please note that you must not communicate the following information to Diagnomitra.com through such social media sites:</p><p>&nbsp;</p><p>&ndash; sensitive personal data including (i) special categories of personal data meaning any information revealing racial or ethnic origin, political opinions, religious or philosophical beliefs, or trade union membership, and the processing of genetic data, biometric data for the purpose of uniquely identifying a natural person, data concerning health or data concerning a natural person&rsquo;s sex life or sexual orientation and (ii) other sensitive personal data such as criminal convictions and offences and national identification number ; &ndash; Excessive, inappropriate, offensive or defamatory content. Diagnomitra.com is not responsible for any information posted on those sites on its behalf Diagnomitra.com is only responsible for its own use of the Personal Information received through such sites.</p><p>&nbsp;</p><ol><li><strong>Changes to this Privacy Policy</strong></li></ol><p>Diagnomitra.com reserves the right to update, change or modify this Privacy Policy at any time. The Privacy Policy shall come to effect from the date of publication of such update, change or modification.</p><p>&nbsp;</p><ol><li><strong>Disclaimer&nbsp;</strong></li></ol><p>Diagnomitra.com does not store any account related information or any credit / debit card details. Diagnomitra.com shall not be liable for any loss or damage sustained by Users as a result of any disclosure (inadvertent or otherwise) of any information concerning the User&rsquo;s account, credit cards or debit cards in the course of any online transactions or payments made for any products and/or services offered through the Platform.</p><p>&nbsp;</p><p>In case any Personal Information is shared by you with Diagnomitra.com, which is not requested by Diagnomitra.com during registration, (whether mandatorily or optionally), Diagnomitra.com will not be liable for any information security breach or disclosure in relation to such information.</p><p>&nbsp;</p><p>If you have any questions regarding this Privacy Policy or the protection of your Personal Information, please contact Diagnomitra.com&rsquo;s Data Protection Officer/ Grievance Officer at the following:</p><p>&nbsp;</p><ol><li><strong>Data Protection Officer/ Grievance Officer</strong></li></ol><p>In case you have any complaints and/or grievances in relation to the processing of your Personal Information you can send your complaints via e-mail to our grievance officer:</p><p>&nbsp;</p><p><strong>Grievance Officer</strong></p><p>Diagnomitra HealthCare LLP</p><p>Address &ndash;</p><p>Phone: +91 &ndash; 7532075184</p><p>Email: help@diagnomitra.com</p><p>Time: Mon &ndash; Sat (9:00 &ndash; 18:00)</p></div></div></div></div></div></section>
       @include('footer')
       <style>.privacy_policy .desp{margin:16px 0;line-height:1.7em;font-family:var(--font-second)}.privacy_policy .desp a{text-decoration:underline;color:#00F}.privacy_policy .desp ul,.desp ol{padding-left:1.2rem}.privacy_policy .desp ul li{line-height:1.7em;text-align:left;list-style-type:disc}.privacy_policy .desp ol li{line-height:1.7em;text-align:left;list-style-type:decimal}.privacy_policy .desp p{font-family:var(--font-second);text-align:justify}.privacy_policy li p img{display:flex;width:100%;height:100%;position:unset!important}.privacy_policy .desp li{list-style-type:disc!important}.privacy_policy table tr:nth-child(odd){background:#e8e8e8}.privacy_policy table{width:100%!important;border:1px solid #cecece;margin-bottom:20px;margin-top:30px;display:block}.privacy_policy table td{padding:5px}.privacy_policy p{letter-spacing:.5px;padding-bottom:10px}.privacy_policy p:last-child{padding-bottom:0}.privacy_policy ul,.privacy_policy ol{padding-left:20px;margin:10px 0}.privacy_policy ul li{list-style-type:disc}.privacy_policy ol li{list-style-type:decimal}.privacy_policy .content-section-wrapper{padding:2.5rem 0}.privacy_policy .content-div{overflow:auto;margin:10px 30px 0}.privacy_policy .content-div iframe,.privacy_policy .content-div video{height:250px!important}.privacy_policy .content-div img,.privacy_policy .content-div video,.privacy_policy .content-div iframe{float:left;margin-right:20px;height:auto;width:400px;object-fit:contain;margin-top:16px}@media screen and (max-width:768px){.privacy_policy .content-section-wrapper{padding:1.5rem 0}.privacy_policy .content-div img{display:block;height:auto;width:100%;margin-bottom:20px}}</style><style>#popup_3 .theme-title .jwset{font-size:px;font-family:;font-weight:;line-height:;letter-spacing:}#popup_3 .theme-subtitle .jwset{font-size:px;font-family:;font-weight:;line-height:;letter-spacing:}</style><style>.banner2-popup{position:fixed;top:0;left:0;z-index:9999;background:rgba(0,0,0,.7);width:100%;height:100vh;display:none}.banner2-popup-content{width:60%;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);z-index:9999;padding:0;position:relative;border:2px solid var(--white);max-height:90vh;overflow-y:auto;overflow-x:hidden}.banner2-popup-content2{width:40%}.banner2-popup-content::-webkit-scrollbar{width:1px}.close-popup{position:absolute;top:0;right:0;z-index:9999}.close-popup a{padding:4px 8px;font-size:13px;color:var(--color1);background:var(--color5)}.banner2-list{margin-bottom:1rem}@media(max-width:768px){.banner2-popup-content{width:90%}}.banner2-form2 li{list-style:none;margin-bottom:1rem}.banner2-form2 label{margin-bottom:.5rem;font-size:13px}.banner2-form2 .jw_dynamic_form li{width:100%}.banner2-form2 form .dynamicField input{margin-bottom:0rem}.banner2-form2 input,.banner2-form2 select,.banner2-form2 textarea{width:100%;padding:.8rem;background:none;border:1px solid #bbb}.banner2-form2 input:focus,.banner2-form2 textarea:focus,.banner2-form2 select:focus{border-color:var(--color1);outline:0}.banner2-form2 input::placeholder{font-size:12px}.banner2-form2 input[type=submit]{background:var(--color1);color:var(--color5);width:100%;padding:1rem 3rem}.banner2-form2 input[type=submit]:hover{background:var(--color5);color:var(--color1);border:1px solid var(--color1)}.banner2-media img{width:100%;height:100%;object-fit:cover}</style><div class="banner2-popup" id="popup_3" data-popup="248962"><div class="banner2-popup-content background5 banner2-popup-content2"><div class="close-popup"><a href="#" class="popup-close" id="popup-close"><i class="fa-solid fa-x"></i></a></div><div class="row "><div class="col-sm-6 d-flex flex-column justify-content-center flex-grow-1"><div class="p-3"><div class="fontStyle3 mg-0 theme-title">Book a Test</div></div><div class="banner2-form2 p-4 fontStyle7"><form class="jw_dynamic_form" name="form_v_3"><signature style="display:none">W10=</signature><li class="dynamicField" data-input="text" data-mode="system"><label>Full Name</label><input type="text" data-name="firstName" date-mode="system" data-input="text" class="jw_dynamic_input " tooltip="" placeholder="Enter Name" maxlength="100" errmsg="" required></li><li class="dynamicField" data-input="email" data-mode="system"><label>Email</label><input type="email" data-name="email" date-mode="system" data-input="email" class="jw_dynamic_input " tooltip="" placeholder="Enter Your Email" maxlength="100" errmsg="" required></li><li class="dynamicField" data-input="tel" data-mode="system"><label>Mobile Number</label><input type="tel" data-name="mobileNumber" date-mode="system" data-input="tel" class="jw_dynamic_input " tooltip="" placeholder="Enter Number" maxlength="100" errmsg="" required></li><li class="dynamicField" data-input="text" data-mode="system"><label>Your location</label><input type="text" data-name="subject" date-mode="system" data-input="text" class="jw_dynamic_input " tooltip="" placeholder="Enter Location" maxlength="100" errmsg="" required></li><li class="dynamicField" data-input="singlefile" data-mode="normal"><label>Upload Prescription</label><input type="file" data-name="UploadPrescription_683" name="UploadPrescription_683" data-input="singlefile" date-mode="normal" class="jw_dynamic_input" name="jw_files[]" accept=".pdf,.doc,.docx,.txt,.xls,.ppt"/></li><li style="display:none;" class="dynamicField otpcode" data-input="otpcode" data-mode="system"><label>Enter OTP</label><input type="text" data-name="otpcode" date-mode="system" data-input="text" class="jw_dynamic_input " tooltip="" placeholder="Enter OTP" maxlength="6" minlength="3" errmsg=""><a href="javascript:void(0);" class="_back2form">Change Email</a></li><input type="hidden" class="_tx_" value="76657"><li><input type="submit" class="see-button" value= "Book Now"></li></form></div></div></div></div></div><script>try{
...
</html><script>console.log('JWBolt - Page loaded in 0.27606201171875 seconds')</script>